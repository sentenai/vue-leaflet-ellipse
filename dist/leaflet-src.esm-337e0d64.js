...
var ni = 0;
function x(t) {
  return "_leaflet_id" in t || (t._leaflet_id = ++ni), t._leaflet_id;
}
function oi(t, e, i) {
  var n, o, s, r;
  return r = function() {
...
var hn = /\{ *([\w_ -]+) *\}/g;
function ri(t, e) {
  return t.replace(hn, function(i, n) {
    var o = e[n];
    if (o === void 0)
...
var Ge = 0;
function ai(t) {
  var e = +new Date(), i = Math.max(0, 16 - (e - Ge));
  return Ge = e + i, window.setTimeout(t, i);
}
var re = window.requestAnimationFrame || se("RequestAnimationFrame") || ai, hi = window.cancelAnimationFrame || se("CancelAnimationFrame") || se("CancelRequestAnimationFrame") || function(t) {
...
nt.extend = function(t) {
  ...
  return t.statics && P(e, t.statics), t.includes && (un(t.includes), P.apply(null, [n].concat(t.includes))), P(n, t), delete n.statics, delete n.includes, n.options && (n.options = i.options ? Ft(i.options) : {}, P(n.options, t.options)), n._initHooks = [], n.callInitHooks = function() {
...
function d(t, e, i) {
  return t instanceof m ? t : q(t) ? new m(t[0], t[1]) : t == null ? t : typeof t == "object" && "x" in t && "y" in t ? new m(t.x, t.y) : new m(t, e, i);
}
function S(t, e) {
  if (t)
...
S.prototype = {
  ...
  extend: function(t) {
    ...
    if (t instanceof m || typeof t[0] == "number" || "x" in t)
      e = i = d(t);
    else if (t = N(t), e = t.min, i = t.max, !e || !i)
      return this;
  ...
  contains: function(t) {
    var e, i;
    return typeof t[0] == "number" || t instanceof m ? t = d(t) : t = N(t), t instanceof S ? (e = t.min, i = t.max) : e = i = t, e.x >= this.min.x && i.x <= this.max.x && e.y >= this.min.y && i.y <= this.max.y;
  },
  ...
  equals: function(t) {
    return t ? (t = N(t), this.min.equals(t.getTopLeft()) && this.max.equals(t.getBottomRight())) : !1;
  }
};
function N(t, e) {
...
R.prototype = {
  ...
  extend: function(t) {
    ...
    if (t instanceof w)
      ...
      return t ? this.extend(b(t) || I(t)) : this;
    return !e && !i ? (this._southWest = new w(n.lat, n.lng), this._northEast = new w(o.lat, o.lng)) : (e.lat = Math.min(n.lat, e.lat), e.lng = Math.min(n.lng, e.lng), i.lat = Math.max(o.lat, i.lat), i.lng = Math.max(o.lng, i.lng)), this;
  },
  ...
  pad: function(t) {
    ...
    return new R(
      new w(e.lat - n, e.lng - o),
      new w(i.lat + n, i.lng + o)
    );
  },
  ...
  // Returns `true` if the rectangle contains the given point.
  contains: function(t) {
    typeof t[0] == "number" || t instanceof w || "lat" in t ? t = b(t) : t = I(t);
    var e = this._southWest, i = this._northEast, n, o;
    return t instanceof R ? (n = t.getSouthWest(), o = t.getNorthEast()) : n = o = t, n.lat >= e.lat && o.lat <= i.lat && n.lng >= e.lng && o.lng <= i.lng;
  },
...
function b(t, e, i) {
  return t instanceof w ? t : q(t) && typeof t[0] != "object" ? t.length === 3 ? new w(t[0], t[1], t[2]) : t.length === 2 ? new w(t[0], t[1]) : null : t == null ? t : typeof t == "object" && "lat" in t ? new w(t.lat, "lng" in t ? t.lng : t.lon, t.alt) : e === void 0 ? null : new w(t, e, i);
}
var ot = {
  ...
  wrapLatLng: function(t) {
    var e = this.wrapLng ? bt(t.lng, this.wrapLng, !0) : t.lng, i = this.wrapLat ? bt(t.lat, this.wrapLat, !0) : t.lat, n = t.alt;
    return new w(i, e, n);
  },
  ...
  wrapLatLngBounds: function(t) {
    ...
    if (n === 0 && o === 0)
      return t;
    var s = t.getSouthWest(), r = t.getNorthEast(), a = new w(s.lat - n, s.lng - o), h = new w(r.lat - n, r.lng - o);
    return new R(a, h);
  }
}, it = P({}, ot, {
  wrapLng: [-180, 180],
...
var ge = document.documentElement.style, Yt = "ActiveXObject" in window, cn = Yt && !document.addEventListener, fi = "msLaunchUri" in navigator && !("documentMode" in document), ye = j("webkit"), di = j("android"), _i = j("android 2") || j("android 3"), fn = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), dn = di && j("Google") && fn < 537 && !("AudioNode" in window), xe = !!window.opera, mi = !fi && j("chrome"), pi = j("gecko") && !ye && !xe && !Yt, _n = !mi && j("safari"), vi = j("phantom"), gi = "OTransition" in ge, mn = navigator.platform.indexOf("Win") === 0, yi = Yt && "transition" in ge, we = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !_i, xi = "MozPerspective" in ge, pn = !window.L_DISABLE_3D && (yi || we || xi) && !gi && !vi, Zt = typeof orientation < "u" || j("mobile"), vn = Zt && ye, gn = Zt && we, wi = !window.PointerEvent && window.MSPointerEvent, Pi = !!(window.PointerEvent || wi), Li = "ontouchstart" in window || !!window.TouchEvent, yn = !window.L_NO_TOUCH && (Li || Pi), xn = Zt && xe, wn = Zt && pi, Pn = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, Ln = function() {
  var t = !1;
  try {
...
}(), Pe = !!(document.createElementNS && li("svg").createSVGRect), bn = !!Pe && function() {
...
}(), Cn = navigator.platform.indexOf("Mac") === 0, zn = navigator.platform.indexOf("Linux") === 0;
function j(t) {
...
var c = {
  ...
  mac: Cn,
  linux: zn
}, Ti = c.msPointer ? "MSPointerDown" : "pointerdown", bi = c.msPointer ? "MSPointerMove" : "pointermove", Mi = c.msPointer ? "MSPointerUp" : "pointerup", Ci = c.msPointer ? "MSPointerCancel" : "pointercancel", he = {
  touchstart: Ti,
  touchmove: bi,
  touchend: Mi,
  touchcancel: Ci
...
function Sn(t, e, i) {
  return e === "touchstart" && On(), Ye[e] ? (i = Ye[e].bind(this, i), t.addEventListener(he[e], i, !1), i) : (console.warn("wrong event specified:", e), k);
}
function kn(t, e, i) {
  if (!he[e]) {
...
function On() {
  Xe || (document.addEventListener(Ti, Zn, !0), document.addEventListener(bi, En, !0), document.addEventListener(Mi, Je, !0), document.addEventListener(Ci, Je, !0), Xe = !0);
}
function Nt(t, e) {
...
function In(t, e) {
  e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && A(e), Nt(t, e);
}
function An(t) {
  var e = {}, i, n;
  for (n in t)
...
), zi = wt === "webkitTransition" || wt === "OTransition" ? wt + "End" : "transitionend";
function Si(t) {
...
function Z(t, e) {
  t.classList !== void 0 ? t.classList.remove(e) : be(t, me((" " + Xt(t) + " ").replace(" " + e + " ", " ")));
}
function be(t, e) {
...
function O(t, e) {
  t._leaflet_pos = e, c.any3d ? ct(t, e) : (t.style.left = e.x + "px", t.style.top = e.y + "px");
}
function ft(t) {
...
if ("onselectstart" in document)
  Ct = function() {
    _(window, "selectstart", A);
  }, zt = function() {
    T(window, "selectstart", A);
  };
else {
  var yt = Jt(
  ...
  Ct = function() {
    ...
    yt && (document.documentElement.style[yt] = oe, oe = void 0);
  };
}
function Me() {
  _(window, "dragstart", A);
}
function Ce() {
  T(window, "dragstart", A);
}
var Rt, ue;
function ze(t) {
  for (; t.tabIndex === -1; )
    t = t.parentNode;
  t.style && (Ut(), Rt = t, ue = t.style.outline, t.style.outline = "none", _(window, "keydown", Ut));
}
function Ut() {
  Rt && (Rt.style.outline = ue, Rt = void 0, ue = void 0, T(window, "keydown", Ut));
}
function ki(t) {
  do
    t = t.parentNode;
...
function ce(t, e, i, n) {
  ...
  !c.touchNative && c.pointer && e.indexOf("touch") === 0 ? s = Sn(t, e, s) : c.touch && e === "dblclick" ? s = Nn(t, s) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(le[e] || e, s, c.passiveEvents ? { passive: !1 } : !1) : e === "mouseenter" || e === "mouseleave" ? (s = function(a) {
    a = a || window.event, Ze(t, a) && r(a);
  }, t.addEventListener(le[e], s, !1)) : t.addEventListener(e, r, !1) : t.attachEvent("on" + e, s), t[G] = t[G] || {}, t[G][o] = s;
}
function fe(t, e, i, n, o) {
  ...
  if (!s)
    return this;
  !c.touchNative && c.pointer && e.indexOf("touch") === 0 ? kn(t, e, s) : c.touch && e === "dblclick" ? Rn(t, s) : "removeEventListener" in t ? t.removeEventListener(le[e] || e, s, !1) : t.detachEvent("on" + e, s), t[G][o] = null;
}
function ut(t) {
  return t.stopPropagation ? t.stopPropagation() : t.originalEvent ? t.originalEvent._stopped = !0 : t.cancelBubble = !0, this;
}
function ke(t) {
  return ce(t, "wheel", ut), this;
}
function Et(t) {
  return _(t, "mousedown touchstart dblclick contextmenu", ut), t._leaflet_disable_click = !0, this;
}
function A(t) {
  return t.preventDefault ? t.preventDefault() : t.returnValue = !1, this;
}
function dt(t) {
  return A(t), ut(t), this;
}
function Zi(t) {
  if (t.composedPath)
...
function Ei(t, e) {
  ...
  var i = Se(e), n = i.boundingClientRect;
  return new m(
...
var Hn = c.linux && c.chrome ? window.devicePixelRatio : c.mac ? window.devicePixelRatio * 3 : window.devicePixelRatio > 0 ? 2 * window.devicePixelRatio : 1;
function Oi(t) {
  return c.edge ? t.wheelDeltaY / 2 : (
    // Don't trust window-geometry-based delta
    t.deltaY && t.deltaMode === 0 ? -t.deltaY / Hn : (
      // Pixels
...
var mo = {
  ...
  run: function(t, e, i, n) {
    this.stop(), this._el = t, this._inProgress = !0, this._duration = i || 0.25, this._easeOutPower = 1 / Math.max(n || 0.5, 0.2), this._startPos = ft(t), this._offset = e.subtract(this._startPos), this._startTime = +new Date(), this.fire("start"), this._animate();
  },
  // @method stop()
  ...
  flyTo: function(t, e, i) {
    ...
    t = b(t), e = e === void 0 ? r : e;
    var a = Math.max(s.x, s.y), h = a * this.getZoomScale(r, e), u = o.distanceTo(n) || 1, l = 1.42, f = l * l;
    function v(E) {
      var At = E ? -1 : 1, on = E ? h : a, sn = h * h - a * a + At * f * f * u * u, rn = 2 * on * f * u, ne = sn / rn, Ve = Math.sqrt(ne * ne + 1) - ne, an = Ve < 1e-9 ? -18 : Math.log(Ve);
      return an;
    }
    function H(E) {
    ...
    function Qi(E) {
      return a * (rt($) * It($ + l * E) - H($)) / f;
    }
    function tn(E) {
      return 1 - Math.pow(1 - E, 1.5);
    }
    var en = Date.now(), Ue = (v(1) - $) / l, nn = i.duration ? 1e3 * i.duration : 1e3 * Ue * 0.8;
    function qe() {
      var E = (Date.now() - en) / nn, At = tn(E) * Ue;
      E <= 1 ? (this._flyToFrame = B(qe, this), this._move(
        this.unproject(n.add(o.subtract(n).multiplyBy(Qi(At) / u)), r),
        this.getScaleZoom(a / ie(At), r),
        { flyTo: !0 }
      )) : this._move(t, e)._moveEnd(!0);
    }
    return this._moveStart(!0, i.noMoveStart), qe.call(this), this;
  },
  ...
  panInside: function(t, e) {
    e = e || {};
    var i = d(e.paddingTopLeft || e.padding || [0, 0]), n = d(e.paddingBottomRight || e.padding || [0, 0]), o = this.project(this.getCenter()), s = this.project(t), r = this.getPixelBounds(), a = N([r.min.add(i), r.max.subtract(n)]), h = a.getSize();
    if (!a.contains(s)) {
      this._enforcingBounds = !0;
  ...
  _handleGeolocationResponse: function(t) {
    if (this._container._leaflet_id) {
      var e = t.coords.latitude, i = t.coords.longitude, n = new w(e, i), o = n.toBounds(t.coords.accuracy * 2), s = this._locateOptions;
      if (s.setView) {
  ...
  remove: function() {
    ...
    this._locationWatchId !== void 0 && this.stopLocate(), this._stop(), C(this._mapPane), this._clearControlPos && this._clearControlPos(), this._resizeRequest && (W(this._resizeRequest), this._resizeRequest = null), this._clearHandlers(), this._loaded && this.fire("unload");
    var t;
  ...
  getBoundsZoom: function(t, e, i) {
    t = I(t), i = d(i || [0, 0]);
    var n = this.getZoom() || 0, o = this.getMinZoom(), s = this.getMaxZoom(), r = t.getNorthWest(), a = t.getSouthEast(), h = this.getSize().subtract(i), u = N(this.project(a, n), this.project(r, n)).getSize(), l = c.any3d ? this.options.zoomSnap : 1, f = h.x / u.x, v = h.y / u.y, H = e ? Math.max(f, v) : Math.min(f, v);
    return n = this.getScaleZoom(H, n), l && (n = Math.round(n / (l / 100)) * (l / 100), n = e ? Math.ceil(n / l) * l : Math.floor(n / l) * l), Math.max(o, Math.min(s, n));
  },
  // @method getSize(): Point
  ...
  _initContainer: function(t) {
    ...
    _(e, "scroll", this._onScroll, this), this._containerId = x(e);
  },
  ...
  _onResize: function() {
    W(this._resizeRequest), this._resizeRequest = B(
      function() {
  ...
  _findEventTargets: function(t, e) {
    for (var i = [], n, o = e === "mouseout" || e === "mouseover", s = t.target || t.srcElement, r = !1; s; ) {
      ...
      if (n && n.listens(e, !0) && (o && !Ze(s, t) || (i.push(n), o)) || s === this._container)
        break;
      s = s.parentNode;
    }
  ...
  _getMapPanePos: function() {
    return ft(this._mapPane) || new m(0, 0);
  },
  _moved: function() {
    var t = this._getMapPanePos();
  ...
  _tryAnimatedZoom: function(t, e, i) {
    ...
    return i.animate !== !0 && !this.getSize().contains(o) ? !1 : (B(function() {
...
var Ii = K.extend({
  ...
  _initLayout: function() {
    ...
    e.setAttribute("aria-haspopup", !0), Et(e), ke(e);
    ...
    o.href = "#", o.title = "Layers", o.setAttribute("role", "button"), _(o, {
      ...
      click: function(s) {
        A(s), this._expandSafely();
      }
    }, this), i || this.expand(), this._baseLayersList = y("div", t + "-base", n), this._separator = y("div", t + "-separator", n), this._overlaysList = y("div", t + "-overlays", n), e.appendChild(n);
  },
  ...
  _addItem: function(t) {
    ...
    t.overlay ? (n = document.createElement("input"), n.type = "checkbox", n.className = "leaflet-control-layers-selector", n.defaultChecked = i) : n = this._createRadioElement("leaflet-base-layers_" + x(this), i), this._layerControlInputs.push(n), n.layerId = x(t.layer), _(n, "click", this._onInputClick, this);
  ...
  _expandSafely: function() {
    var t = this._section;
    _(t, "click", A), this.expand(), setTimeout(function() {
      T(t, "click", A);
    });
  }
}), Wn = function(t, e, i) {
  ...
  _createButton: function(t, e, i, n, o) {
    var s = y("a", i, n);
    return s.innerHTML = t, s.href = "#", s.title = e, s.setAttribute("role", "button"), s.setAttribute("aria-label", e), Et(s), _(s, "click", dt), _(s, "click", o, this), _(s, "click", this._refocusOnMap, this), s;
  },
...
var Un = function(t) {
  ...
  return new Ai(t);
}, Vn = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg>', Oe = K.extend({
  // @section
  ...
  options: {
    ...
    prefix: '<a href="https://leafletjs.com" title="A JavaScript library for interactive maps">' + (c.inlineSvg ? Vn + " " : "") + "Leaflet</a>"
  },
  initialize: function(t) {
    z(this, t), this._attributions = {};
  },
  onAdd: function(t) {
    t.attributionControl = this, this._container = y("div", "leaflet-control-attribution"), Et(this._container);
...
J.addTo = function(t, e) {
  return t.addHandler(e, this), this;
};
var vo = { Events: D }, Qe = c.touch ? "touchstart mousedown" : "mousedown", at = jt.extend({
  options: {
    // @section
  ...
  enable: function() {
    this._enabled || (_(this._dragStartTarget, Qe, this._onDown, this), this._enabled = !0);
  },
  // @method disable()
  // Disables the dragging ability
  disable: function() {
    this._enabled && (at._dragging === this && this.finishDrag(!0), T(this._dragStartTarget, Qe, this._onDown, this), this._enabled = !1, this._moved = !1);
  },
  _onDown: function(t) {
    if (this._enabled && (this._moved = !1, !Te(this._element, "leaflet-zoom-anim"))) {
      ...
      if (!(at._dragging || t.shiftKey || t.which !== 1 && t.button !== 1 && !t.touches) && (at._dragging = this, this._preventOutline && ze(this._element), Me(), Ct(), !this._moving)) {
        this.fire("down");
        var e = t.touches ? t.touches[0] : t, i = ki(this._element);
        this._startPoint = new m(e.clientX, e.clientY), this._startPos = ft(this._element), this._parentScale = Se(i);
  ...
  _onMove: function(t) {
    if (this._enabled) {
      ...
      !i.x && !i.y || Math.abs(i.x) + Math.abs(i.y) < this.options.clickTolerance || (i.x /= this._parentScale.x, i.y /= this._parentScale.y, A(t), this._moved || (this.fire("dragstart"), this._moved = !0, p(document.body, "leaflet-dragging"), this._lastTarget = t.target || t.srcElement, window.SVGElementInstance && this._lastTarget instanceof window.SVGElementInstance && (this._lastTarget = this._lastTarget.correspondingUseElement), p(this._lastTarget, "leaflet-drag-target")), this._newPos = this._startPos.add(i), this._moving = !0, this._lastEvent = t, this._updatePosition());
    }
  },
  ...
  finishDrag: function(t) {
    Z(document.body, "leaflet-dragging"), this._lastTarget && (Z(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null), T(document, "mousemove touchmove", this._onMove, this), T(document, "mouseup touchend touchcancel", this._onUp, this), Ce(), zt(), this._moved && this._moving && this.fire("dragend", {
      noInertia: t,
...
function Bi(t, e) {
  if (!e || !t.length)
    return t.slice();
  var i = e * e;
  return t = Yn(t, i), t = Kn(t, i), t;
}
function Ni(t, e, i) {
  return Math.sqrt(Ot(t, e, i, !0));
}
function jn(t, e, i) {
  return Ot(t, e, i);
}
...
function de(t, e, i, n, o) {
  var s = 0, r, a, h;
  for (a = n + 1; a <= o - 1; a++)
    h = Ot(t[a], t[n], t[o], !0), h > s && (r = a, s = h);
  s > i && (e[r] = 1, de(t, e, i, n, r), de(t, e, i, r, o));
}
function Yn(t, e) {
  for (var i = [t[0]], n = 1, o = 0, s = t.length; n < s; n++)
    Xn(t[n], t[o]) > e && (i.push(t[n]), o = n);
  return o < s - 1 && i.push(t[s - 1]), i;
}
var ti;
function Ri(t, e, i, n, o) {
  var s = n ? ti : lt(t, i), r = lt(e, i), a, h, u;
  for (ti = r; ; ) {
    if (!(s | r))
      return [t, e];
    if (s & r)
      return !1;
    a = s || r, h = qt(t, e, a, i, o), u = lt(h, i), a === s ? (t = h, s = u) : (e = h, r = u);
  }
}
...
function Di(t) {
  return console.warn("Deprecated use of _flat, please use L.LineUtil.isFlat instead."), U(t);
}
function Hi(t, e) {
  var i, n, o, s, r, a, h, u;
  if (!t || t.length === 0)
    throw new Error("latlngs not passed");
  U(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
  var l = [];
  for (var f in t)
    l.push(e.project(b(t[f])));
  var v = l.length;
  for (i = 0, n = 0; i < v - 1; i++)
  ...
  return e.unproject(d(u));
}
var go = {
  __proto__: null,
  simplify: Bi,
  pointToSegmentDistance: Ni,
...
function Fi(t, e, i) {
  ...
  for (a = 0; a < 4; a++) {
    for (f = o[a], n = [], s = 0, l = t.length, r = l - 1; s < l; r = s++)
      h = t[s], u = t[r], h._code & f ? u._code & f || (v = qt(u, h, f, e, i), v._code = lt(v, e), n.push(v)) : (u._code & f && (v = qt(u, h, f, e, i), v._code = lt(v, e), n.push(v)), n.push(h));
    t = n;
  }
  return t;
}
function Wi(t, e) {
  ...
  var f = [];
  for (var v in t)
    f.push(e.project(b(t[v])));
  var H = f.length;
  for (a = h = u = 0, i = 0, n = H - 1; i < H; n = i++)
    o = f[i], s = f[n], r = o.y * s.x - s.y * o.x, h += (o.x + s.x) * r, u += (o.y + s.y) * r, a += r * 3;
  return a === 0 ? l = f[0] : l = [h / a, u / a], e.unproject(d(l));
}
var yo = {
  __proto__: null,
  clipPolygon: Fi,
...
var Lt = St.extend({
  ...
  _getIconUrl: function(t) {
    return typeof Lt.imagePath != "string" && (Lt.imagePath = this._detectIconPath()), (this.options.imagePath || Lt.imagePath) + St.prototype._getIconUrl.call(this, t);
  },
  ...
  _detectIconPath: function() {
    var t = y("div", "leaflet-default-icon-path", document.body), e = Mt(t, "background-image") || Mt(t, "backgroundImage");
  ...
  _adjustPan: function(t) {
    var e = this._marker, i = e._map, n = this._marker.options.autoPanSpeed, o = this._marker.options.autoPanPadding, s = ft(e._icon), r = i.getPixelBounds(), a = i.getPixelOrigin(), h = N(
    ...
    if (!h.contains(s)) {
      ...
      i.panBy(u, { animate: !1 }), this._draggable._newPos._add(u), this._draggable._startPos._add(u), O(e._icon, this._draggable._newPos), this._onDrag(t), this._panRequest = B(this._adjustPan.bind(this, t));
    }
  },
  ...
  _onPreDrag: function(t) {
    this._marker.options.autoPan && (W(this._panRequest), this._panRequest = B(this._adjustPan.bind(this, t)));
  },
  _onDrag: function(t) {
  ...
  _initInteraction: function() {
    if (this.options.interactive && (p(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), ei)) {
...
var _t = Y.extend({
  ...
  initialize: function(t, e) {
    z(this, e), this._latlng = b(t), this._radius = this.options.radius;
  },
  // @method setLatLng(latLng: LatLng): this
  ...
  setStyle: function(t) {
    ...
    return _t.prototype.setStyle.call(this, t), this.setRadius(e), this;
  },
  _project: function() {
...
var qi = Be.extend({
  initialize: function(t, e, i) {
    if (typeof e == "number" && (e = P({}, i, { radius: e })), z(this, e), this._latlng = b(t), isNaN(this.options.radius))
...
var tt = _t.extend({
  ...
  closestLayerPoint: function(t) {
    for (var e = 1 / 0, i = null, n = Ot, o, s, r = 0, a = this._parts.length; r < a; r++)
  ...
  _defaultShape: function() {
    return U(this._latlngs) ? this._latlngs : this._latlngs[0];
  },
  // recursively convert latlngs input into actual LatLng instances; calculate bounds along the way
  _convertLatLngs: function(t) {
    for (var e = [], i = U(t), n = 0, o = t.length; n < o; n++)
  ...
  _projectLatlngs: function(t, e, i) {
    var n = t[0] instanceof w, o = t.length, s, r;
    if (n) {
      for (r = [], s = 0; s < o; s++)
    ...
    if (this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
      ...
      for (i = 0, o = 0, s = this._rings.length; i < s; i++)
        for (h = this._rings[i], n = 0, r = h.length; n < r - 1; n++)
          a = Ri(h[n], h[n + 1], t, n, !0), a && (e[o] = e[o] || [], e[o].push(a[0]), (a[1] !== h[n + 1] || n === r - 2) && (e[o].push(a[1]), o++));
    }
  },
...
var kt = tt.extend({
  ...
  _setLatLngs: function(t) {
    tt.prototype._setLatLngs.call(this, t), U(this._latlngs) && (this._latlngs = [this._latlngs]);
  },
  _defaultShape: function() {
    return U(this._latlngs[0]) ? this._latlngs[0] : this._latlngs[0][0];
  },
  _clipPoints: function() {
    ...
    if (t = new S(t.min.subtract(i), t.max.add(i)), this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
      ...
      for (var n = 0, o = this._rings.length, s; n < o; n++)
        s = Fi(this._rings[n], t, !0), s.length && this._parts.push(s);
    }
  },
  _updatePath: function() {
...
var st = et.extend({
  ...
  addData: function(t) {
    ...
    if (s.filter && !s.filter(t))
      return this;
    var r = Vt(t, s);
    return r ? (r.feature = te(t), r.defaultOptions = r.options, this.resetStyle(r), s.onEachFeature && s.onEachFeature(t, r), this.addLayer(r)) : this;
  },
...
function Vt(t, e) {
  var i = t.type === "Feature" ? t.geometry : t, n = i ? i.coordinates : null, o = [], s = e && e.pointToLayer, r = e && e.coordsToLatLng || Ne, a, h, u, l;
  if (!n && !i)
    return null;
  switch (i.type) {
    case "Point":
      return a = r(n), ii(s, t, a, e);
    case "MultiPoint":
      for (u = 0, l = n.length; u < l; u++)
        a = r(n[u]), o.push(ii(s, t, a, e));
      return new et(o);
    case "LineString":
    case "MultiLineString":
      return h = Gt(n, i.type === "LineString" ? 0 : 1, r), new tt(h, e);
    case "Polygon":
    case "MultiPolygon":
      return h = Gt(n, i.type === "Polygon" ? 1 : 2, r), new kt(h, e);
...
function Gt(t, e, i) {
  for (var n = [], o = 0, s = t.length, r; o < s; o++)
    r = e ? Gt(t[o], e - 1, i) : (i || Ne)(t[o]), n.push(r);
  return n;
}
function Re(t, e) {
...
function Qt(t, e, i, n) {
  for (var o = [], s = 0, r = t.length; s < r; s++)
    o.push(e ? Qt(t[s], U(t[s]) ? 0 : e - 1, i, n) : Re(t[s], n));
  return !e && i && o.push(o[0].slice()), o;
}
function pt(t, e) {
  return t.feature ? P({}, t.feature, { geometry: e }) : te(e);
}
function te(t) {
...
var De = {
  toGeoJSON: function(t) {
    return pt(this, {
      type: "Point",
      coordinates: Re(this.getLatLng(), t)
    });
  }
};
Ae.include(De);
...
tt.include({
  toGeoJSON: function(t) {
    var e = !U(this._latlngs), i = Qt(this._latlngs, e ? 1 : 0, !1, t);
    return pt(this, {
...
kt.include({
  toGeoJSON: function(t) {
    var e = !U(this._latlngs), i = e && !U(this._latlngs[0]), n = Qt(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
...
var X = Y.extend({
  ...
  initialize: function(t, e) {
    t && (t instanceof w || q(t)) ? (this._latlng = b(t), z(this, e)) : (z(this, t), this._source = e), this.options.content && (this._content = this.options.content);
  },
  ...
  onAdd: function(t) {
    this._zoomAnimated = t._zoomAnimated, this._container || this._initLayout(), t._fadeAnimated && F(this._container, 0), clearTimeout(this._removeTimeout), this.getPane().appendChild(this._container), this.update(), t._fadeAnimated && F(this._container, 1), this.bringToFront(), this.options.interactive && (p(this._container, "leaflet-interactive"), this.addInteractiveTarget(this._container));
  },
  onRemove: function(t) {
    t._fadeAnimated ? (F(this._container, 0), this._removeTimeout = setTimeout(M(C, void 0, this._container), 200)) : C(this._container), this.options.interactive && (Z(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container));
  },
...
var Fe = X.extend({
  ...
  openOn: function(t) {
    return t = arguments.length ? t : this._source._map, !t.hasLayer(this) && t._popup && t._popup.options.autoClose && t.removeLayer(t._popup), t._popup = this, X.prototype.openOn.call(this, t);
  },
  onAdd: function(t) {
    X.prototype.onAdd.call(this, t), t.fire("popupopen", { popup: this }), this._source && (this._source.fire("popupopen", { popup: this }, !0), this._source instanceof _t || this._source.on("preclick", ut));
  },
  onRemove: function(t) {
    X.prototype.onRemove.call(this, t), t.fire("popupclose", { popup: this }), this._source && (this._source.fire("popupclose", { popup: this }, !0), this._source instanceof _t || this._source.off("preclick", ut));
  },
  getEvents: function() {
  ...
  _initLayout: function() {
    ...
    if (this._contentNode = y("div", t + "-content", i), Et(e), ke(this._contentNode), _(e, "contextmenu", ut), this._tipContainer = y("div", t + "-tip-container", e), this._tip = y("div", t + "-tip", this._tipContainer), this.options.closeButton) {
  ...
  _adjustPan: function() {
    if (this.options.autoPan) {
      ...
      var t = this._map, e = parseInt(Mt(this._container, "marginBottom"), 10) || 0, i = this._container.offsetHeight + e, n = this._containerWidth, o = new m(this._containerLeft, -i - this._containerBottom);
...
Y.include({
  ...
  bindPopup: function(t, e) {
    return this._popup = this._initOverlay(Fe, this._popup, t, e), this._popupHandlersAdded || (this.on({
  ...
  openPopup: function(t) {
    return this._popup && (this instanceof et || (this._popup._source = this), this._popup._prepareOpen(t || this._latlng) && this._popup.openOn(this._map)), this;
  },
  ...
  _openPopup: function(t) {
    if (!(!this._popup || !this._map)) {
      ...
      if (this._popup._source === e && !(e instanceof _t)) {
...
var We = X.extend({
  ...
  onAdd: function(t) {
    X.prototype.onAdd.call(this, t), this.setOpacity(this.options.opacity), t.fire("tooltipopen", { tooltip: this }), this._source && (this.addEventParent(this._source), this._source.fire("tooltipopen", { tooltip: this }, !0));
  },
  onRemove: function(t) {
    X.prototype.onRemove.call(this, t), t.fire("tooltipclose", { tooltip: this }), this._source && (this.removeEventParent(this._source), this._source.fire("tooltipclose", { tooltip: this }, !0));
  },
  getEvents: function() {
    var t = X.prototype.getEvents.call(this);
...
Y.include({
  ...
  openTooltip: function(t) {
    return this._tooltip && (this instanceof et || (this._tooltip._source = this), this._tooltip._prepareOpen(t) && (this._tooltip.openOn(this._map), this.getElement ? this._setAriaDescribedByOnLayer(this) : this.eachLayer && this.eachLayer(this._setAriaDescribedByOnLayer, this))), this;
  },
...
var io = St.extend({
  ...
  createIcon: function(t) {
    ...
    if (i.html instanceof Element ? (Wt(e), e.appendChild(i.html)) : e.innerHTML = i.html !== !1 ? i.html : "", i.bgPos) {
      var n = d(i.bgPos);
...
var Dt = Y.extend({
  ...
  bringToBack: function() {
    return this._map && (gt(this._container), this._setAutoZIndex(Math.min)), this;
  },
  // @method getContainer: HTMLElement
  ...
  getEvents: function() {
    ...
    return this.options.updateWhenIdle || (this._onMove || (this._onMove = oi(this._onMoveEnd, this.options.updateInterval, this)), t.move = this._onMove), this._zoomAnimated && (t.zoomanim = this._animateZoom), t;
  },
  // @section Extension methods
    ...
    if (this._map && !c.ielt9) {
      ...
      for (var n in this._tiles) {
        ...
        if (!(!o.current || !o.loaded)) {
          ...
          F(o.el, s), s < 1 ? e = !0 : (o.active ? i = !0 : this._onOpaqueTile(o), o.active = !0);
        }
      }
      i && !this._noPrune && this._pruneTiles(), e && (W(this._fadeFrame), this._fadeFrame = B(this._updateOpacity, this));
    }
  },
  _onOpaqueTile: k,
  ...
  _updateLevels: function() {
    ...
    if (t !== void 0) {
      ...
      return n || (n = this._levels[t] = {}, n.el = y("div", "leaflet-tile-container leaflet-zoom-animated", this._container), n.el.style.zIndex = e, n.origin = o.project(o.unproject(o.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, o.getCenter(), o.getZoom()), k(n.el.offsetWidth), this._onCreateLevel(n)), this._level = n, n;
    }
  },
  _onUpdateLevel: k,
  _onRemoveLevel: k,
        ...
        for (var f = o.min.y; f <= o.max.y; f++)
          for (var v = o.min.x; v <= o.max.x; v++) {
            ...
            if (H.z = this._tileZoom, !!this._isValidTile(H)) {
              var rt = this._tiles[this._tileCoordsToKey(H)];
              rt ? rt.current = !0 : r.push(H);
            }
          }
        if (r.sort(function($, ie) {
          return $.distanceTo(s) - ie.distanceTo(s);
        }), r.length !== 0) {
          this._loading || (this._loading = !0, this.fire("loading"));
          var It = document.createDocumentFragment();
          for (v = 0; v < r.length; v++)
            this._addTile(r[v], It);
  ...
  _tileCoordsToBounds: function(t) {
    var e = this._tileCoordsToNwSe(t), i = new R(e[0], e[1]);
  ...
  _initTile: function(t) {
    ...
    t.style.width = e.x + "px", t.style.height = e.y + "px", t.onselectstart = k, t.onmousemove = k, c.ielt9 && this.options.opacity < 1 && F(t, this.options.opacity);
  },
  _addTile: function(t, e) {
    var i = this._getTilePos(t), n = this._tileCoordsToKey(t), o = this.createTile(this._wrapCoords(t), M(this._tileReady, this, t));
    this._initTile(o), this.createTile.length < 2 && B(M(this._tileReady, this, t, null, o)), O(o, i), this._tiles[n] = {
      el: o,
      coords: t,
      current: !0
  ...
  _tileReady: function(t, e, i) {
    ...
    i = this._tiles[n], i && (i.loaded = +new Date(), this._map._fadeAnimated ? (F(i.el, 0), W(this._fadeFrame), this._fadeFrame = B(this._updateOpacity, this)) : (i.active = !0, this._pruneTiles()), e || (p(i.el, "leaflet-tile-loaded"), this.fire("tileload", {
      tile: i.el,
      coords: t
    })), this._noTilesToLoad() && (this._loading = !1, this.fire("load"), c.ielt9 || !this._map._fadeAnimated ? B(this._pruneTiles, this) : setTimeout(M(this._pruneTiles, this), 250)));
  },
...
var Tt = Dt.extend({
  ...
  getTileUrl: function(t) {
    ...
    return ri(this._url, P(e, this.options));
  },
  ...
  _removeTile: function(t) {
    var e = this._tiles[t];
    if (e)
      return e.el.setAttribute("src", Bt), Dt.prototype._removeTile.call(this, t);
  },
  _tileReady: function(t, e, i) {
...
var Vi = Tt.extend({
  ...
  getTileUrl: function(t) {
    var e = this._tileCoordsToNwSe(t), i = this._crs, n = N(i.project(e[0]), i.project(e[1])), o = n.min, s = n.max, r = (this._wmsVersion >= 1.3 && this._crs === Ui ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(","), a = Tt.prototype.getTileUrl.call(this, t);
...
var Q = Y.extend({
  ...
  onAdd: function() {
    this._container || (this._initContainer(), this._zoomAnimated && p(this._container, "leaflet-zoom-animated")), this.getPane().appendChild(this._container), this._update(), this.on("update", this._updatePaths, this);
  },
  onRemove: function() {
  ...
  _updateTransform: function(t, e) {
    ...
    c.any3d ? ct(this._container, s, i) : O(this._container, s);
  },
  _reset: function() {
  ...
  onAdd: function() {
    Q.prototype.onAdd.call(this), this._draw();
  },
  _initContainer: function() {
  ...
  _destroyContainer: function() {
    W(this._redrawRequest), delete this._ctx, C(this._container), T(this._container), delete this._container;
  },
  _updatePaths: function() {
  ...
  _reset: function() {
    Q.prototype._reset.call(this), this._postponeUpdatePaths && (this._postponeUpdatePaths = !1, this._updatePaths());
  },
...
var xt = function() {
  ...
  _update: function() {
    this._map._animatingZoom || (Q.prototype._update.call(this), this.fire("update"));
  },
  _initPath: function(t) {
    var e = t._container = xt("shape");
    p(e, "leaflet-vml-shape " + (this.options.className || "")), e.coordsize = "1 1", t._path = xt("path"), e.appendChild(t._path), this._updateStyle(t), this._layers[x(t)] = t;
  },
  _addPath: function(t) {
    var e = t._container;
...
c.vml && ee.include(ao);
function ho(t) {
  return c.svg || c.vml ? new ee(t) : null;
}
g.include({
  ...
  _createRenderer: function(t) {
    return this.options.preferCanvas && ro(t) || ho(t);
  }
});
var uo = kt.extend({
  initialize: function(t, e) {
...
ee.create = Ht;
ee.pointsToPath = ci;
st.geometryToLayer = Vt;
st.coordsToLatLng = Ne;
st.coordsToLatLngs = Gt;
st.latLngToCoords = Re;
st.latLngsToCoords = Qt;
st.getFeature = pt;
st.asFeature = te;
g.mergeOptions({
...
var Gi = J.extend({
  ...
  _onMouseDown: function(t) {
    if (!t.shiftKey || t.which !== 1 && t.button !== 1)
      return !1;
    this._clearDeferredResetState(), this._resetState(), Ct(), Me(), this._startPoint = this._map.mouseEventToContainerPoint(t), _(document, {
      contextmenu: dt,
  ...
  _onMouseMove: function(t) {
    this._moved || (this._moved = !0, this._box = y("div", "leaflet-zoom-box", this._container), p(this._container, "leaflet-crosshair"), this._map.fire("boxzoomstart")), this._point = this._map.mouseEventToContainerPoint(t);
  ...
  _finish: function() {
    this._moved && (C(this._box), Z(this._container, "leaflet-crosshair")), zt(), Ce(), T(document, {
      contextmenu: dt,
      mousemove: this._onMouseMove,
      mouseup: this._onMouseUp,
      keydown: this._onKeyDown
...
g.addInitHook("addHandler", "boxZoom", Gi);
g.mergeOptions({
...
g.addInitHook("addHandler", "doubleClickZoom", ji);
g.mergeOptions({
...
var Ki = J.extend({
  ...
  _onDragEnd: function(t) {
    ...
    if (e.fire("dragend", t), n)
      ...
      !v.x && !v.y ? e.fire("moveend") : (v = e._limitOffset(v, e.options.maxBounds), B(function() {
        e.panBy(v, {
          duration: f,
          easeLinearity: r,
          noMoveStart: !0,
...
g.addInitHook("addHandler", "dragging", Ki);
g.mergeOptions({
  // @option keyboard: Boolean = true
...
g.addInitHook("addHandler", "keyboard", Yi);
g.mergeOptions({
...
g.addInitHook("addHandler", "scrollWheelZoom", Xi);
var lo = 600;
g.mergeOptions({
  ...
  _onDown: function(t) {
    if (clearTimeout(this._holdTimeout), t.touches.length === 1) {
      ...
      this._startPos = this._newPos = new m(e.clientX, e.clientY), this._holdTimeout = setTimeout(M(function() {
        this._cancel(), this._isTapValid() && (_(document, "touchend", A), _(document, "touchend touchcancel", this._cancelClickPrevent), this._simulateEvent("contextmenu", e));
      }, this), lo), _(document, "touchend touchcancel contextmenu", this._cancel, this), _(document, "touchmove", this._onMove, this);
    }
  },
  _cancelClickPrevent: function t() {
    T(document, "touchend", A), T(document, "touchend touchcancel", t);
  },
  _cancel: function() {
...
g.addInitHook("addHandler", "tapHold", Ji);
g.mergeOptions({
  // @section Touch interaction options
...
var $i = J.extend({
  ...
  _onTouchMove: function(t) {
    if (!(!t.touches || t.touches.length !== 2 || !this._zooming)) {
      ...
      this._animRequest = B(r, this, !0), A(t);
    }
  },
...
g.addInitHook("addHandler", "touchZoom", $i);
g.BoxZoom = Gi;
g.DoubleClickZoom = ji;
g.Drag = Ki;
g.Keyboard = Yi;
g.ScrollWheelZoom = Xi;
g.TapHold = Ji;
g.TouchZoom = $i;
export {
  S as Bounds,
